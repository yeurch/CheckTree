/**
    ...
    Contribution this project (v0.4b)
    Author: Francis Frago <kiko_paolo@yahoo.com>
...
(function (jQuery) {
    jQuery.fn.checkTree = function (settings) {
        ...
        */
        ...
        // Dont display the children if set to 'false'
        if (settings.displayChildren === 'false') {
